...
function output_status_options($stat_type_offset)
{
  ...
  $output .= "
    <option value= \"0\" {$stat_type[0]} > 0: ".lang('item', 'mana')."</option>
    <option value= \"1\" {$stat_type[1]} > 1: ".lang('item', 'health')."</option>
    <option value= \"3\" {$stat_type[3]} > 3: ".lang('item', 'agility')."</option>
    <option value= \"4\" {$stat_type[4]} > 4: ".lang('item', 'strength')."</option>
    <option value= \"5\" {$stat_type[5]} > 5: ".lang('item', 'intellect')."</option>
    <option value= \"6\" {$stat_type[6]} > 6: ".lang('item', 'spirit')."</option>
    <option value= \"7\" {$stat_type[7]} > 7: ".lang('item', 'stamina')."</option>
    <option value=\"12\" {$stat_type[12]}>12: ".lang('item', 'DEFENCE_RATING')."</option>
    <option value=\"13\" {$stat_type[13]}>13: ".lang('item', 'DODGE_RATING')."</option>
    <option value=\"14\" {$stat_type[14]}>14: ".lang('item', 'PARRY_RATING')."</option>
    <option value=\"15\" {$stat_type[15]}>15: ".lang('item', 'SHIELD_BLOCK_RATING')."</option>
    <option value=\"16\" {$stat_type[16]}>16: ".lang('item', 'MELEE_HIT_RATING')."</option>
    <option value=\"17\" {$stat_type[17]}>17: ".lang('item', 'RANGED_HIT_RATING')."</option>
    <option value=\"18\" {$stat_type[18]}>18: ".lang('item', 'SPELL_HIT_RATING')."</option>
    <option value=\"19\" {$stat_type[19]}>19: ".lang('item', 'MELEE_CS_RATING')."</option>
    <option value=\"20\" {$stat_type[20]}>20: ".lang('item', 'RANGED_CS_RATING')."</option>
    <option value=\"21\" {$stat_type[21]}>21: ".lang('item', 'SPELL_CS_RATING')."</option>
    <option value=\"22\" {$stat_type[22]}>22: ".lang('item', 'MELEE_HA_RATING')."</option>
    <option value=\"23\" {$stat_type[23]}>23: ".lang('item', 'RANGED_HA_RATING')."</option>
    <option value=\"24\" {$stat_type[24]}>24: ".lang('item', 'SPELL_HA_RATING')."</option>
    <option value=\"25\" {$stat_type[25]}>25: ".lang('item', 'MELEE_CA_RATING')."</option>
    <option value=\"26\" {$stat_type[26]}>26: ".lang('item', 'RANGED_CA_RATING')."</option>
    <option value=\"27\" {$stat_type[27]}>27: ".lang('item', 'SPELL_CA_RATING')."</option>
    <option value=\"28\" {$stat_type[28]}>28: ".lang('item', 'MELEE_HASTE_RATING')."</option>
    <option value=\"29\" {$stat_type[29]}>29: ".lang('item', 'RANGED_HASTE_RATING')."</option>
    <option value=\"30\" {$stat_type[30]}>30: ".lang('item', 'SPELL_HASTE_RATING')."</option>
    <option value=\"31\" {$stat_type[31]}>31: ".lang('item', 'HIT_RATING')."</option>
    <option value=\"32\" {$stat_type[32]}>32: ".lang('item', 'CS_RATING')."</option>
    <option value=\"33\" {$stat_type[33]}>33: ".lang('item', 'HA_RATING')."</option>
    <option value=\"34\" {$stat_type[34]}>34: ".lang('item', 'CA_RATING')."</option>
    <option value=\"35\" {$stat_type[35]}>35: ".lang('item', 'RESILIENCE_RATING')."</option>
    <option value=\"36\" {$stat_type[36]}>36: ".lang('item', 'HASTE_RATING')."</option>";
...
function output_dmgtype_options($dmg_type_offset)
{
  ...
  $output .= "
    <option value=\"0\" {$dmg_type[0]}>0: ".lang('item', 'physical_dmg')."</option>
    <option value=\"1\" {$dmg_type[1]}>1: ".lang('item', 'holy_dmg')."</option>
    <option value=\"2\" {$dmg_type[2]}>2: ".lang('item', 'fire_dmg')."</option>
    <option value=\"3\" {$dmg_type[3]}>3: ".lang('item', 'nature_dmg')."</option>
    <option value=\"4\" {$dmg_type[4]}>4: ".lang('item', 'frost_dmg')."</option>
    <option value=\"5\" {$dmg_type[5]}>5: ".lang('item', 'shadow_dmg')."</option>
    <option value=\"6\" {$dmg_type[6]}>6: ".lang('item', 'arcane_dmg')."</option>";
...
function search()
{
  global $output, $arcm_db, $world_db, $realm_id, $action_permission, $user_lvl, $sqlw, $sqlm, $sqld;

  valid_login($action_permission['view']);

  $result = $sqlw->query("SELECT count(*) FROM items");
  $tot_items = $sqlw->result($result, 0);

  $output .= "
        <center>
          <fieldset class=\"full_frame\">
            <legend>".lang('item_edit', 'search_item')."</legend><br />
            <form action=\"item.php?action=do_search&amp;error=2\" method=\"post\" name=\"form\">
              <table class=\"hidden\">
                <tr>
                  <td align=\"right\">".lang('item_edit', 'entry').":</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"entry\" /></td>
                  <td align=\"right\">".lang('item_edit', 'item_name').":</td>
                  <td align=\"right\" colspan=\"3\"><input type=\"text\" size=\"24\" maxlength=\"35\" name=\"name\" /></td>
                  <td align=\"right\">".lang('item_edit', 'model_id').":</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"displayid\" /></td>
                </tr>
                <tr>
                  <td align=\"right\" width=\"10%\">".lang('item_edit', 'class').":</td>
                  <td align=\"right\" width=\"10%\">
                    <select name=\"class\">
                      <option value=\"-1\">".lang('item_edit', 'all')."</option>
                      <option value=\"0\">".lang('item', 'consumable')."</option>
                      <option value=\"1\">".lang('item', 'bag')."</option>
                      <option value=\"2\">".lang('item', 'weapon')."</option>
                      <option value=\"4\">".lang('item', 'armor')."</option>
                      <option value=\"5\">".lang('item', 'reagent')."</option>
                      <option value=\"6\">".lang('item', 'projectile')."</option>
                      <option value=\"7\">".lang('item', 'trade_goods')."</option>
                      <option value=\"9\">".lang('item', 'recipe')."</option>
                      <option value=\"11\">".lang('item', 'quiver')."</option>
                      <option value=\"12\">".lang('item', 'quest')."</option>
                      <option value=\"13\">".lang('item', 'key')."</option>
                      <option value=\"14\">".lang('item', 'permanent')."</option>
                      <option value=\"15\">".lang('item', 'misc_short')."</option>
                    </select>
                  </td>
                  <td align=\"right\" width=\"10%\">".lang('item_edit', 'quality').":</td>
                  <td align=\"right\" width=\"10%\">
                    <select name=\"Quality\">
                      <option value=\"-1\">".lang('item_edit', 'all')."</option>
                      <option value=\"0\">".lang('item', 'poor')."</option>
                      <option value=\"1\">".lang('item', 'common')."</option>
                      <option value=\"2\">".lang('item', 'uncommon')."</option>
                      <option value=\"3\">".lang('item', 'rare')."</option>
                      <option value=\"4\">".lang('item', 'epic')."</option>
                      <option value=\"5\">".lang('item', 'legendary')."</option>
                      <option value=\"6\">".lang('item', 'artifact')."</option>
                      <option value=\"7\">".lang('item', 'heirloom')."</option>
                    </select>
                  </td>
                  <td align=\"right\" width=\"10%\">".lang('item_edit', 'inv_type').":</td>
                  <td align=\"right\" width=\"10%\">
                    <select name=\"InventoryType\">
                      <option value=\"-1\">".lang('item_edit', 'all')."</option>
                      <option value=\"1\">".lang('item', 'head')."</option>
                      <option value=\"2\">".lang('item', 'neck')."</option>
                      <option value=\"3\">".lang('item', 'shoulder')."</option>
                      <option value=\"4\">".lang('item', 'shirt')."</option>
                      <option value=\"5\">".lang('item', 'chest')."</option>
                      <option value=\"6\">".lang('item', 'belt')."</option>
                      <option value=\"7\">".lang('item', 'legs')."</option>
                      <option value=\"8\">".lang('item', 'feet')."</option>
                      <option value=\"9\">".lang('item', 'belt')."</option>
                      <option value=\"10\">".lang('item', 'gloves')."</option>
                      <option value=\"11\">".lang('item', 'finger')."</option>
                      <option value=\"12\">".lang('item', 'trinket')."</option>
                      <option value=\"13\">".lang('item', 'one_hand')."</option>
                      <option value=\"14\">".lang('item', 'off_hand')."</option>
                      <option value=\"15\">".lang('item', 'bow')."</option>
                      <option value=\"16\">".lang('item', 'back')."</option>
                      <option value=\"17\">".lang('item', 'two_hand')."</option>
                      <option value=\"18\">".lang('item', 'bag')."</option>
                      <option value=\"19\">".lang('item', 'tabard')."</option>
                      <option value=\"20\">".lang('item', 'robe')."</option>
                      <option value=\"21\">".lang('item', 'main_hand')."</option>
                      <option value=\"22\">".lang('item', 'off_misc')."</option>
                      <option value=\"23\">".lang('item', 'tome')."</option>
                      <option value=\"24\">".lang('item', 'projectile')."</option>
                      <option value=\"25\">".lang('item', 'thrown')."</option>
                      <option value=\"26\">".lang('item', 'rifle')."</option>
                    </select>
                  </td>
                  <td align=\"right\" width=\"10%\">".lang('item_edit', 'req_level').":</td>
                  <td align=\"right\" width=\"10%\"><input type=\"text\" size=\"6\" maxlength=\"3\" name=\"RequiredLevel\" /></td>
                </tr>
                <tr>
                  <td align=\"right\">".lang('item_edit', 'spell_id')." 1:</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"spellid_1\" /></td>
                  <td align=\"right\">".lang('item_edit', 'spell_id')." 2:</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"spellid_2\" /></td>
                  <td align=\"right\">".lang('item_edit', 'spell_id')." 3:</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"spellid_3\" /></td>
                  <td align=\"right\">".lang('item_edit', 'spell_id')." 4:</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"spellid_4\" /></td>
                </tr>
                <tr>
                  <td align=\"right\">".lang('item_edit', 'item_level').":</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"ItemLevel\" /></td>
                  <td align=\"right\">".lang('item_edit', 'item_set').":</td>
                  <td align=\"right\" colspan=\"3\">
                    <select name=\"itemset\">
                      <option value=\"\">".lang('item_edit', 'all')."</option>";
  $itemset_id = $sqld->query("SELECT `ID`, `itemname` FROM `itemset`");
  while($set = $sqld->fetch_row($itemset_id))
    $output .= "
                      <option value=\"{$set[0]}\">($set[0]) {$set[1]}</option>";
  $output .= "
                    </select>
                  </td>
                  <td align=\"right\">".lang('item_edit', 'flags').":</td>
                  <td align=\"right\"><input type=\"text\" size=\"6\" maxlength=\"6\" name=\"Flags\" /></td>
                </tr>
                <tr>
                  <td align=\"right\">".lang('item_edit', 'bonding').":</td>
                  <td align=\"right\" colspan=\"2\">
                    <select name=\"bonding\">
                      <option value=\"-1\">".lang('item_edit', 'all')."</option>
                      <option value=\"1\">".lang('item', 'bop')."</option>
                      <option value=\"2\">".lang('item', 'boe')."</option>
                      <option value=\"3\">".lang('item', 'bou')."</option>
                      <option value=\"4\">".lang('item', 'quest_item')."</option>
                    </select>
                  </td>
                  <td align=\"right\">".lang('item_edit', 'custom_search').":</td>
  ...
  if($user_lvl >= $action_permission['insert'])
                    makebutton(lang('item_edit', 'add_new_item'), "item.php?action=add_new&error=3",130);
                    makebutton(lang('item_edit', 'search'), "javascript:do_submit()",130);
  $output .= "
                  </td>
                  <td align=\"right\" colspan=\"2\">".lang('item_edit', 'tot_items_in_db').": $tot_items</td>
                  <td align=\"right\"></td>
                </tr>
              </table>
            </form>
...
function do_search()
{
  global $output, $world_db, $realm_id, $item_datasite, $sql_search_limit, $itemperpage,
    $action_permission, $user_lvl, $sqlw;
  ...
  if(isset($entry))         $where .= "AND items.entry = '$entry' ";
  //if(isset($name))          $where .= "AND IFNULL(".($deplang<>0?"name_loc$deplang":"NULL").",`name1`) LIKE '%$name%' ";
  if(isset($name))          $where .= "AND `name1` LIKE '%$name%' ";
  ...
  if($where == "WHERE items.entry > 0 ") redirect("item.php?error=1");

  //$result = $sqlw->query("SELECT items.entry,displayid,IFNULL(".($deplang<>0?"name_loc$deplang":"NULL").",`name1`) as name,RequiredLevel,ItemLevel FROM items LEFT JOIN items_localized ON items.entry = items_localized.entry $where ORDER BY items.entry LIMIT $sql_search_limit");
  $result = $sqlw->query("SELECT items.entry,displayid, name1,RequiredLevel,ItemLevel FROM items $where ORDER BY items.entry LIMIT $sql_search_limit");
  ...
  $output .= "
              ...
              <td align=\"right\">".lang('item_edit', 'items_found')." : $total_items_found : ".lang('global', 'limit')." $sql_search_limit</td>
            </tr>
          </table>
          <table class=\"lined\">
          <tr>
            <th width=\"10%\">".lang('item_edit', 'entry')."</th>
            <th width=\"10%\">".lang('item_edit', 'display_id')."</th>
            <th width=\"10%\">".lang('item_edit', 'item_name')."</th>
            <th width=\"10%\">".lang('item_edit', 'req_level')."</th>
            <th width=\"10%\">".lang('item_edit', 'item_level')."</th>
          </tr>";
  for ($i=0; $i<$total_items_found; $i++)
  {
    ...
    $output .= "
          <tr>
            ...
            <td>
              <a id=\"item_padding\" href=\"$item_datasite$item[0]\" target=\"_blank\">
...
//########################################################################################################################
function add_new() {
 global $output, $item_datasite, $action_permission, $user_lvl;
...
<td>".makeinfocell(lang('item_edit', 'class'),lang('item_edit', 'class_desc'))."</td>
  <td colspan=\"3\"><select name=\"class\">
    <option value=\"0\">0 - ".lang('item', 'consumable')."</option>
    <option value=\"1\">1 - ".lang('item', 'bag')."</option>
    <option value=\"2\">2 - ".lang('item', 'weapon')."</option>
    <option value=\"4\">4 - ".lang('item', 'armor')."</option>
    <option value=\"5\">5 - ".lang('item', 'reagent')."</option>
    <option value=\"6\">6 - ".lang('item', 'projectile')."</option>
    <option value=\"7\">7 - ".lang('item', 'trade_goods')."</option>
    <option value=\"9\">9 - ".lang('item', 'recipe')."</option>
    <option value=\"11\">11 - ".lang('item', 'quiver')."</option>
    <option value=\"12\">12 - ".lang('item', 'quest')."</option>
    <option value=\"13\">13 - ".lang('item', 'key')."</option>
    <option value=\"14\">14 - ".lang('item', 'permanent')."</option>
    <option value=\"15\">15 - ".lang('item', 'misc_short')."</option>
     </select></td>

 <td>".makeinfocell(lang('item_edit', 'subclass'),lang('item_edit', 'subclass_desc'))."</td>
  <td colspan=\"3\"><select name=\"subclass\">
    <option value=\"0\">0 - ".lang('item', 'none')."</option>
  <optgroup label=\"Class 0: ".lang('item', 'consumable')."\">
    <option value=\"0\">0 - ".lang('item', 'consumable')."</option>
    <option value=\"3\">3 - ".lang('item', 'potion')."</option>
    <option value=\"4\">4 - ".lang('item', 'scroll')."</option>
    <option value=\"5\">5 - ".lang('item', 'bandage')."</option>
    <option value=\"6\">6 - ".lang('item', 'healthstone')."</option>
    <option value=\"7\">7 - ".lang('item', 'combat_effect')."</option>
  <optgroup label=\"Class 1: ".lang('item', 'bag')."\">
    <option value=\"0\">0 - ".lang('item', 'bag')."</option>
    <option value=\"1\">1 - ".lang('item', 'soul_shards')."</option>
    <option value=\"2\">2 - ".lang('item', 'herbs')."</option>
    <option value=\"3\">3 - ".lang('item', 'enchanting')."</option>
    <option value=\"4\">4 - ".lang('item', 'engineering')."</option>
    <option value=\"5\">5 - ".lang('item', 'gems')."</option>
    <option value=\"6\">6 - ".lang('item', 'mining')."</option>
  <optgroup label=\"Class 2: ".lang('item', 'weapon')."\">
    <option value=\"0\">0 - ".lang('item', 'axe_1h')."</option>
    <option value=\"1\">1 - ".lang('item', 'axe_2h')."</option>
    <option value=\"2\">2 - ".lang('item', 'bow')."</option>
    <option value=\"3\">3 - ".lang('item', 'rifle')."</option>
    <option value=\"4\">4 - ".lang('item', 'mace_1h')."</option>
    <option value=\"5\">5 - ".lang('item', 'mace_2h')."</option>
    <option value=\"6\">6 - ".lang('item', 'polearm')."</option>
    <option value=\"7\">7 - ".lang('item', 'sword_1h')."</option>
    <option value=\"8\">8 - ".lang('item', 'sword_2h')."</option>
    <option value=\"10\">10 - ".lang('item', 'staff')."</option>
    <option value=\"11\">11 - ".lang('item', 'exotic_1h')."</option>
    <option value=\"12\">12 - ".lang('item', 'exotic_2h')."</option>
    <option value=\"13\">13 - ".lang('item', 'fist_weapon')."</option>
    <option value=\"14\">14 - ".lang('item', 'misc_weapon')."</option>
    <option value=\"15\">15 - ".lang('item', 'dagger')."</option>
    <option value=\"16\">16 - ".lang('item', 'thrown')."</option>
    <option value=\"17\">17 - ".lang('item', 'spear')."</option>
    <option value=\"18\">18 - ".lang('item', 'crossbow')."</option>
    <option value=\"19\">19 - ".lang('item', 'wand')."</option>
    <option value=\"20\">20 - ".lang('item', 'fishing_pole')."</option>
  </optgroup>
  <optgroup label=\"Class 4: ".lang('item', 'armor')."\">
    <option value=\"0\">0 - ".lang('item', 'misc')."</option>
    <option value=\"1\">1 - ".lang('item', 'cloth')."</option>
    <option value=\"2\">2 - ".lang('item', 'leather')."</option>
    <option value=\"3\">3 - ".lang('item', 'mail')."</option>
    <option value=\"4\">4 - ".lang('item', 'plate')."</option>
    <option value=\"5\">5 - ".lang('item', 'buckler')."</option>
    <option value=\"6\">6 - ".lang('item', 'shield')."</option>
    <option value=\"7\">7 - ".lang('item', 'libram')."</option>
    <option value=\"8\">8 - ".lang('item', 'idol')."</option>
    <option value=\"9\">9 - ".lang('item', 'totem')."</option>
  </optgroup>
  <optgroup label=\"Class 6: ".lang('item', 'projectile')."\">
    <option value=\"2\">2 - ".lang('item', 'arrows')."</option>
    <option value=\"3\">3 - ".lang('item', 'bullets')."</option>
  </optgroup>
  <optgroup label=\"Class 7: ".lang('item', 'trade_goods')."\">
    <option value=\"0\">0 - ".lang('item', 'trade_goods')."</option>
    <option value=\"1\">1 - ".lang('item', 'parts')."</option>
    <option value=\"2\">2 - ".lang('item', 'explosives')."</option>
    <option value=\"3\">3 - ".lang('item', 'devices')."</option>
  </optgroup>
  <optgroup label=\"Class 9: ".lang('item', 'recipe')."\">
    <option value=\"0\">0 - ".lang('item', 'book')."</option>
    <option value=\"1\">1 - ".lang('item', 'LW_pattern')."</option>
    <option value=\"2\">2 - ".lang('item', 'tailoring_pattern')."</option>
    <option value=\"3\">3 - ".lang('item', 'ENG_Schematic')."</option>
    <option value=\"4\">4 - ".lang('item', 'BS_plans')."</option>
    <option value=\"5\">5 - ".lang('item', 'cooking_recipe')."</option>
    <option value=\"6\">6 - ".lang('item', 'alchemy_recipe')."</option>
    <option value=\"7\">7 - ".lang('item', 'FA_manual')."</option>
    <option value=\"8\">8 - ".lang('item', 'ench_formula')."</option>
    <option value=\"9\">9 - ".lang('item', 'fishing_manual')."</option>
    <option value=\"10\">10 - ".lang('item', 'JC_formula')."</option>
  </optgroup>
  <optgroup label=\"Class 11: ".lang('item', 'quiver')."\">
    <option value=\"2\">2 - ".lang('item', 'quiver')."</option>
    <option value=\"3\">3 - ".lang('item', 'ammo_pouch')."</option>
  </optgroup>
  <optgroup label=\"Class 13: ".lang('item', 'key')."\">
    <option value=\"0\">0 - ".lang('item', 'key')."</option>
    <option value=\"1\">1 - ".lang('item', 'lockpick')."</option>
  </optgroup>
 </select></td>
</tr>
<tr>

<td>".makeinfocell(lang('item_edit', 'quality'),lang('item_edit', 'quality_desc'))."</td>
   <td colspan=\"2\"><select name=\"Quality\">
    <option value=\"0\">0 - ".lang('item', 'poor')."</option>
    <option value=\"1\">1 - ".lang('item', 'common')."</option>
    <option value=\"2\">2 - ".lang('item', 'uncommon')."</option>
    <option value=\"3\">3 - ".lang('item', 'rare')."</option>
    <option value=\"4\">4 - ".lang('item', 'epic')."</option>
    <option value=\"5\">5 - ".lang('item', 'legendary')."</option>
    <option value=\"6\">6 - ".lang('item', 'artifact')."</option>
    <option value=\"7\">7 - ".lang('item', 'heirloom')."</option>
     </select></td>

<td>".makeinfocell(lang('item_edit', 'inv_type'),lang('item_edit', 'inv_type_desc'))."</td>
    <td colspan=\"2\"><select name=\"InventoryType\">
    <option value=\"0\">0 - ".lang('item', 'other')."</option>
    <option value=\"1\">1 - ".lang('item', 'head')."</option>
    <option value=\"2\">2 - ".lang('item', 'neck')."</option>
    <option value=\"3\">3 - ".lang('item', 'shoulder')."</option>
    <option value=\"4\">4 - ".lang('item', 'shirt')."</option>
    <option value=\"5\">5 - ".lang('item', 'chest')."</option>
    <option value=\"6\">6 - ".lang('item', 'belt')."</option>
    <option value=\"7\">7 - ".lang('item', 'legs')."</option>
    <option value=\"8\">8 - ".lang('item', 'feet')."</option>
    <option value=\"9\">9 - ".lang('item', 'belt')."</option>
    <option value=\"10\">10 - ".lang('item', 'gloves')."</option>
    <option value=\"11\">11 - ".lang('item', 'finger')."</option>
    <option value=\"12\">12 - ".lang('item', 'trinket')."</option>
    <option value=\"13\">13 - ".lang('item', 'one_hand')."</option>
    <option value=\"14\">14 - ".lang('item', 'off_hand')."</option>
    <option value=\"15\">15 - ".lang('item', 'bow')."</option>
    <option value=\"16\">16 - ".lang('item', 'back')."</option>
    <option value=\"17\">17 - ".lang('item', 'two_hand')."</option>
    <option value=\"18\">18 - ".lang('item', 'bag')."</option>
    <option value=\"19\">19 - ".lang('item', 'tabard')."</option>
    <option value=\"20\">20 - ".lang('item', 'robe')."</option>
    <option value=\"21\">21 - ".lang('item', 'main_hand')."</option>
    <option value=\"22\">22 - ".lang('item', 'off_misc')."</option>
    <option value=\"23\">23 - ".lang('item', 'tome')."</option>
    <option value=\"24\">24 - ".lang('item', 'projectile')."</option>
    <option value=\"25\">25 - ".lang('item', 'thrown')."</option>
    <option value=\"26\">26 - ".lang('item', 'rifle')."</option>
     </select></td>
...
<td>".makeinfocell(lang('item_edit', 'bonding'),lang('item_edit', 'bonding_desc'))."</td>
   <td colspan=\"3\"><select name=\"bonding\">
    <option value=\"0\">0 - ".lang('item', 'no_bind')."</option>
    <option value=\"1\">1 - ".lang('item', 'bop')."</option>
    <option value=\"2\">2 - ".lang('item', 'boe')."</option>
    <option value=\"3\">3 - ".lang('item', 'bou')."</option>
    <option value=\"4\">4 - ".lang('item', 'quest_item')."</option>
    <option value=\"5\">5 - ".lang('item', 'quest_item')."1</option>
     </select></td>
...
$output .= "<div id=\"pane2\">
  ...
  <td>".makeinfocell(lang('item_edit', 'bag_family'),lang('item_edit', 'bag_family_desc'))."</td>
   <td><select name=\"BagFamily\">
    <option value=\"0\">0 - ".lang('item', 'none')."</option>
    <option value=\"1\">1 - ".lang('item', 'arrows')."</option>
    <option value=\"2\">2 - ".lang('item', 'bullets')."</option>
    <option value=\"3\">3 - ".lang('item', 'soul_shards')."</option>
    <option value=\"6\">6 - ".lang('item', 'herbs')."</option>
    <option value=\"7\">7 - ".lang('item', 'enchanting')."</option>
    <option value=\"8\">8 - ".lang('item', 'engineering')."</option>
    <option value=\"9\">9 - ".lang('item', 'keys')."</option>
    <option value=\"10\">10 - ".lang('item', 'gems')."</option>
    <option value=\"12\">12 - ".lang('item', 'mining')."</option>
     </select></td>
...
<td></td><td></td>
  ...
  <td>".makeinfocell(lang('item_edit', 'material'),lang('item_edit', 'material_desc'))."</td>
   <td colspan=\"2\"><select name=\"Material\">
    <option value=\"-1\">-1 - ".lang('item_edit', 'consumables')."</option>
    <option value=\"-1\">0 - ".lang('item_edit', 'none')."</option>
    <option value=\"1\">1 - ".lang('item_edit', 'metal')."</option>
    <option value=\"2\">2 - ".lang('item_edit', 'wood')."</option>
    <option value=\"3\">3 - ".lang('item_edit', 'liquid')."</option>
    <option value=\"4\">4 - ".lang('item_edit', 'jewelry')."</option>
    <option value=\"5\">5 - ".lang('item_edit', 'chain')."</option>
    <option value=\"6\">6 - ".lang('item_edit', 'plate')."</option>
    <option value=\"7\">7 - ".lang('item_edit', 'cloth')."</option>
    <option value=\"8\">8 - ".lang('item_edit', 'leather')."</option>
     </select></td>

  <td>".makeinfocell(lang('item_edit', 'page_material'),lang('item_edit', 'page_material_desc'))."</td>
   <td colspan=\"2\"><select name=\"PageMaterial\">
    <option value=\"0\">0 - ".lang('item_edit', 'none')."</option>
    <option value=\"1\">1 - ".lang('item_edit', 'parchment')."</option>
    <option value=\"2\">2 - ".lang('item_edit', 'stone')."</option>
    <option value=\"3\">3 - ".lang('item_edit', 'marble')."</option>
    <option value=\"4\">4 - ".lang('item_edit', 'silver')."</option>
    <option value=\"5\">5 - ".lang('item_edit', 'bronze')."</option>
     </select></td>

<td>".makeinfocell(lang('item_edit', 'max_durability'),lang('item_edit', 'max_durability_desc'))."</td>
...
<tr class=\"large_bold\"><td colspan=\"8\" class=\"hidden\" align=\"left\">".lang('item_edit', 'other').":</td></tr>
  <tr>
   ...
   <td>".makeinfocell(lang('item_edit', 'unk0'),lang('item_edit', 'unk0_desc'))."</td>
  ...
  <tr>
   ...
   <td colspan=\"2\"><select name=\"LanguageID\">
    <option value=\"0\">0 - ".lang('item_edit', 'other')."</option>
    ...
    <option value=\"33\">33 - Gutterspeak</option>
     ...
     <td>".makeinfocell(lang('item_edit', 'sheath'),lang('item_edit', 'sheath_desc'))."</td>
   <td colspan=\"2\"><select name=\"sheath\">
    <option value=\"0\">0 - ".lang('item_edit', 'other')."</option>
    <option value=\"1\">1 - ".lang('item', 'sword_2h')."</option>
    <option value=\"2\">2 - ".lang('item', 'staff')."</option>
    <option value=\"3\">3 - ".lang('item', 'sword_1h')."</option>
    <option value=\"4\">4 - ".lang('item', 'shield')."</option>
    <option value=\"5\">5 - ".lang('item', 'rod')."</option>
    <option value=\"7\">7 - ".lang('item', 'off_hand')."</option>
     </select></td>
...
<tr>
 ...
 <td>".makeinfocell(lang('item_edit', 'ammo_type'),lang('item_edit', 'ammo_type_desc'))."</td>
...
<tr>
   <td>".makeinfocell(lang('item_edit', 'damage_type')." 1",lang('item_edit', 'damage_type_desc'))."</td>
...
<tr>
   ...
   <td>".makeinfocell(lang('item_edit', 'spell_trigger'),lang('item_edit', 'spell_trigger_desc'))."</td>
   <td><select name=\"spelltrigger_1\">
    <option value=\"0\">0: ".lang('item', 'spell_use')."</option>
    <option value=\"1\">1: ".lang('item', 'spell_equip')."</option>
    <option value=\"2\">2: ".lang('item', 'spell_coh')."</option>
    <option value=\"4\">4: ".lang('item', 'soul_stone')."</option>
    </select></td>
...
$output .= "<div id=\"pane6\">
    <br /><br /><table class=\"lined\" style=\"width: 720px;\">
   <tr>
   <td>".makeinfocell(lang('item_edit', 'allow_class'),lang('item_edit', 'allow_class_desc'))."</td>
   <td><select multiple=\"multiple\" name=\"AllowableClass[]\" size=\"5\">
    <option value=\"-1\">-1 - ".lang('item_edit', 'all')."</option>
    <option value=\"1\">1 - ".lang('id_tab', 'warrior')."</option>
    <option value=\"2\">2 - ".lang('id_tab', 'paladin')."</option>
    <option value=\"4\">4 - ".lang('id_tab', 'hunter')."</option>
    <option value=\"8\">8 - ".lang('id_tab', 'rogue')."</option>
    <option value=\"16\">16 - ".lang('id_tab', 'priest')."</option>
    <option value=\"64\">64 - ".lang('id_tab', 'shaman')."</option>
    <option value=\"128\">128 - ".lang('id_tab', 'mage')."</option>
    <option value=\"256\">256 - ".lang('id_tab', 'warlock')."</option>
    <option value=\"1024\">1024 - ".lang('id_tab', 'druid')."</option>
     </select></td>

     <td>".makeinfocell(lang('item_edit', 'allow_race'),lang('item_edit', 'allow_race_desc'))."</td>
   <td><select multiple=\"multiple\" name=\"AllowableRace[]\" size=\"5\">
    <option value=\"-1\">-1 - ".lang('item_edit', 'all')."</option>
    <option value=\"1\">1 - ".lang('id_tab', 'human')."</option>
    <option value=\"2\">2 - ".lang('id_tab', 'orc')."</option>
    <option value=\"4\">4 - ".lang('id_tab', 'dwarf')."</option>
    <option value=\"8\">8 - ".lang('id_tab', 'nightelf')."</option>
    <option value=\"16\">16 - ".lang('id_tab', 'undead')."</option>
    <option value=\"32\">32 - ".lang('id_tab', 'tauren')."</option>
    <option value=\"64\">64 - ".lang('id_tab', 'gnome')."</option>
    <option value=\"128\">128 - ".lang('id_tab', 'troll')."</option>
    <option value=\"256\">256 - ".lang('id_tab', 'draenei')."</option>
    <option value=\"512\">512 - ".lang('id_tab', 'bloodelf')."</option>
     </select></td>
...
<tr>
   ...
   <td>".makeinfocell(lang('item_edit', 'req_rep_rank'),lang('item_edit', 'req_rep_rank_desc'))."</td>
      <td><select name=\"RequiredReputationRank\">
    <option value=\"0\">0 - ".lang('item_edit', 'hated')."</option>
    <option value=\"1\">1 - ".lang('item_edit', 'hostile')."</option>
    <option value=\"2\">2 - ".lang('item_edit', 'unfriendly')."</option>
    <option value=\"3\">3 - ".lang('item_edit', 'neutral')."</option>
    <option value=\"4\">4 - ".lang('item_edit', 'friendly')."</option>
    <option value=\"5\">5 - ".lang('item_edit', 'honored')."</option>
    <option value=\"6\">6 - ".lang('item_edit', 'reverted')."</option>
    <option value=\"7\">7 - ".lang('item_edit', 'exalted')."</option>
     </select></td>
</tr>
...
<tr>
   <td>".makeinfocell(lang('item_edit', 'socket_color')." 1",lang('item_edit', 'socket_color_desc'))."</td>
   <td><select name=\"socketColor_1\">
    <option value=\"0\">0: ".lang('item', 'none')."</option>
    <option value=\"1\">1: ".lang('item', 'socket_meta')."</option>
    <option value=\"2\">2: ".lang('item', 'socket_red')."</option>
    <option value=\"4\">4: ".lang('item', 'socket_yellow')."</option>
    <option value=\"8\">8: ".lang('item', 'socket_blue')."</option>
    </select></td>

   <td>".makeinfocell(lang('item_edit', 'socket_content')." 1",lang('item_edit', 'socket_content_desc'))."</td>
   <td><input type=\"text\" name=\"socketContent_1\" size=\"15\" maxlength=\"10\" value=\"0\" /></td>
</tr>
<tr>
   <td>".makeinfocell(lang('item_edit', 'socket_color')." 2",lang('item_edit', 'socket_color_desc'))."</td>
   ...
   <td>".makeinfocell(lang('item_edit', 'socket_content')." 2",lang('item_edit', 'socket_content_desc'))."</td>
   <td><input type=\"text\" name=\"socketContent_2\" size=\"15\" maxlength=\"10\" value=\"0\" /></td>
</tr>
<tr>
   <td>".makeinfocell(lang('item_edit', 'socket_color')." 3",lang('item_edit', 'socket_color_desc'))."</td>
   ...
   <td>".makeinfocell(lang('item_edit', 'socket_content')." 3",lang('item_edit', 'socket_content_desc'))."</td>
...
<script type=\"text/javascript\">setupPanes(\"container\", \"tab1\")</script>";
 ...
 $output .= "<table class=\"hidden\">
          <tr><td>";
       makebutton(lang('item_edit', 'update'), "javascript:do_submit('form1',0)",180);
       makebutton(lang('item_edit', 'export_sql'), "javascript:do_submit('form1',1)",180);
       makebutton(lang('item_edit', 'search_items'), "item.php",180);
 $output .= "</td></tr>
        </table></center>";
...
//########################################################################################################################
function edit() {
 global $output, $world_db, $realm_id, $item_datasite, $lang_id_tab, $quest_datasite,
   $action_permission, $user_lvl, $creature_datasite, $sqlw;
...
<div class=\"jtab-container\" id=\"container\">
  ...
  if ($item['DisenchantID']) $output .= "<li><a href=\"#\" onclick=\"return showPane('pane9', this)\">".lang('item_edit', 'disenchant_tab')."</a></li>";
$output .= "</ul>
  <div class=\"jtab-panes\">";
...
//########################################################################################################################
function do_update() {
 global $world_db, $realm_id, $action_permission, $user_lvl, $sqlw;
...
valid_login($action_permission['update']);
 ...
 if (isset($_POST['class']) && $_POST['class'] != '') $class = $sqlw->quote_smart($_POST['class']);
  else $class = 0;
 if (isset($_POST['subclass']) && $_POST['subclass'] != '') $subclass = $sqlw->quote_smart($_POST['subclass']);
  else $subclass = 0;
 ...
 if (isset($_POST['Quality']) && $_POST['Quality'] != '') $Quality = $sqlw->quote_smart($_POST['Quality']);
  else $Quality = 0;
 if (isset($_POST['Flags']) && $_POST['Flags'] != '') $Flags = $sqlw->quote_smart($_POST['Flags']);
  else $Flags = 0;
 if (isset($_POST['BuyCount']) && $_POST['BuyCount'] != '') $BuyCount = $sqlw->quote_smart($_POST['BuyCount']);
  else $BuyCount = 0;
 if (isset($_POST['BuyPrice']) && $_POST['BuyPrice'] != '') $BuyPrice = $sqlw->quote_smart($_POST['BuyPrice']);
  else $BuyPrice = 0;
 if (isset($_POST['SellPrice']) && $_POST['SellPrice'] != '') $SellPrice = $sqlw->quote_smart($_POST['SellPrice']);
  else $SellPrice = 0;
 if (isset($_POST['InventoryType']) && $_POST['InventoryType'] != '') $InventoryType = $sqlw->quote_smart($_POST['InventoryType']);
  else $AllowableClass = 0;
 if (isset($_POST['AllowableClass'])) $AllowableClass = $sqlw->quote_smart($_POST['AllowableClass']);
  else $AllowableClass = -1;
 if (isset($_POST['AllowableRace'])) $AllowableRace = $sqlw->quote_smart($_POST['AllowableRace']);
  else $AllowableRace = -1;
 if (isset($_POST['ItemLevel']) && $_POST['ItemLevel'] != '') $ItemLevel = $sqlw->quote_smart($_POST['ItemLevel']);
  else $ItemLevel = 1;
 if (isset($_POST['RequiredLevel']) && $_POST['RequiredLevel'] != '') $RequiredLevel = $sqlw->quote_smart($_POST['RequiredLevel']);
  else $RequiredLevel = 0;
 if (isset($_POST['RequiredSkill']) && $_POST['RequiredSkill'] != '') $RequiredSkill = $sqlw->quote_smart($_POST['RequiredSkill']);
  else $RequiredSkill = 0;
 if (isset($_POST['RequiredSkillRank']) && $_POST['RequiredSkillRank'] != '') $RequiredSkillRank = $sqlw->quote_smart($_POST['RequiredSkillRank']);
  else $RequiredSkillRank = 0;
 if (isset($_POST['requiredspell']) && $_POST['requiredspell'] != '') $requiredspell = $sqlw->quote_smart($_POST['requiredspell']);
  else $requiredspell = 0;
 if (isset($_POST['requiredhonorrank']) && $_POST['requiredhonorrank'] != '') $requiredhonorrank = $sqlw->quote_smart($_POST['requiredhonorrank']);
  else $requiredhonorrank = 0;
 if (isset($_POST['RequiredCityRank']) && $_POST['RequiredCityRank'] != '') $RequiredCityRank = $sqlw->quote_smart($_POST['RequiredCityRank']);
  else $RequiredCityRank = 0;
 if (isset($_POST['RequiredReputationFaction']) && $_POST['RequiredReputationFaction'] != '') $RequiredReputationFaction = $sqlw->quote_smart($_POST['RequiredReputationFaction']);
  else $RequiredReputationFaction = 0;
 if (isset($_POST['RequiredReputationRank']) && $_POST['RequiredReputationRank'] != '') $RequiredReputationRank = $sqlw->quote_smart($_POST['RequiredReputationRank']);
  else $RequiredReputationRank = 0;
 if (isset($_POST['maxcount']) && $_POST['maxcount'] != '') $maxcount = $sqlw->quote_smart($_POST['maxcount']);
  else $maxcount = 0;
 if (isset($_POST['stackable']) && $_POST['stackable'] != '') $stackable = $sqlw->quote_smart($_POST['stackable']);
  else $description = 0;
 if (isset($_POST['ContainerSlots']) && $_POST['ContainerSlots'] != '') $ContainerSlots = $sqlw->quote_smart($_POST['ContainerSlots']);
  else $ContainerSlots = 0;
 if (isset($_POST['stat_type1']) && $_POST['stat_type1'] != '') $stat_type1 = $sqlw->quote_smart($_POST['stat_type1']);
  else $stat_type1 = 0;
 if (isset($_POST['stat_value1']) && $_POST['stat_value1'] != '') $stat_value1 = $sqlw->quote_smart($_POST['stat_value1']);
  else $stat_value1 = 0;
 if (isset($_POST['stat_type2']) && $_POST['stat_type2'] != '') $stat_type2 = $sqlw->quote_smart($_POST['stat_type2']);
  else $stat_type2 = 0;
 if (isset($_POST['stat_value2']) && $_POST['stat_value2'] != '') $stat_value2 = $sqlw->quote_smart($_POST['stat_value2']);
  else $stat_value2 = 0;
 if (isset($_POST['stat_type3']) && $_POST['stat_type3'] != '') $stat_type3 = $sqlw->quote_smart($_POST['stat_type3']);
  else $stat_type3 = 0;
 if (isset($_POST['stat_value3']) && $_POST['stat_value3'] != '') $stat_value3 = $sqlw->quote_smart($_POST['stat_value3']);
  else $stat_value3 = 0;
 if (isset($_POST['stat_type4']) && $_POST['stat_type4'] != '') $stat_type4 = $sqlw->quote_smart($_POST['stat_type4']);
  else $stat_type4 = 0;
 if (isset($_POST['stat_value4']) && $_POST['stat_value4'] != '') $stat_value4 = $sqlw->quote_smart($_POST['stat_value4']);
  else $stat_value4 = 0;
 if (isset($_POST['stat_type5']) && $_POST['stat_type5'] != '') $stat_type5 = $sqlw->quote_smart($_POST['stat_type5']);
  else $stat_type5 = 0;
 if (isset($_POST['stat_value5']) && $_POST['stat_value5'] != '') $stat_value5 = $sqlw->quote_smart($_POST['stat_value5']);
  else $stat_value5 = 0;
 if (isset($_POST['stat_type6']) && $_POST['stat_type6'] != '') $stat_type6 = $sqlw->quote_smart($_POST['stat_type6']);
  else $stat_type6 = 0;
 if (isset($_POST['stat_value6']) && $_POST['stat_value6'] != '') $stat_value6 = $sqlw->quote_smart($_POST['stat_value6']);
  else $stat_value6 = 0;
 if (isset($_POST['stat_type7']) && $_POST['stat_type7'] != '') $stat_type7 = $sqlw->quote_smart($_POST['stat_type7']);
  else $stat_type7 = 0;
 if (isset($_POST['stat_value7']) && $_POST['stat_value7'] != '') $stat_value7 = $sqlw->quote_smart($_POST['stat_value7']);
  else $stat_value7 = 0;
 if (isset($_POST['stat_type8']) && $_POST['stat_type8'] != '') $stat_type8 = $sqlw->quote_smart($_POST['stat_type8']);
  else $stat_type8 = 0;
 if (isset($_POST['stat_value8']) && $_POST['stat_value8'] != '') $stat_value8 = $sqlw->quote_smart($_POST['stat_value8']);
  else $stat_value8 = 0;
 if (isset($_POST['stat_type9']) && $_POST['stat_type9'] != '') $stat_type9 = $sqlw->quote_smart($_POST['stat_type9']);
  else $stat_type9 = 0;
 if (isset($_POST['stat_value9']) && $_POST['stat_value9'] != '') $stat_value9 = $sqlw->quote_smart($_POST['stat_value9']);
  else $stat_value9 = 0;
 if (isset($_POST['stat_type10']) && $_POST['stat_type10'] != '') $stat_type10 = $sqlw->quote_smart($_POST['stat_type10']);
  else $stat_type10 = 0;
 if (isset($_POST['stat_value10']) && $_POST['stat_value10'] != '') $stat_value10 = $sqlw->quote_smart($_POST['stat_value10']);
  else $stat_value10 = 0;
 if (isset($_POST['dmg_min1']) && $_POST['dmg_min1'] != '') $dmg_min1 = $sqlw->quote_smart($_POST['dmg_min1']);
  else $dmg_min1 = 0;
 if (isset($_POST['dmg_max1']) && $_POST['dmg_max1'] != '') $dmg_max1 = $sqlw->quote_smart($_POST['dmg_max1']);
  else $dmg_max1 = 0;
 if (isset($_POST['dmg_type1']) && $_POST['dmg_type1'] != '') $dmg_type1 = $sqlw->quote_smart($_POST['dmg_type1']);
  else $dmg_type1 = 0;
 if (isset($_POST['dmg_min2']) && $_POST['dmg_min2'] != '') $dmg_min2 = $sqlw->quote_smart($_POST['dmg_min2']);
  else $dmg_min2 = 0;
 if (isset($_POST['dmg_max2']) && $_POST['dmg_max2'] != '') $dmg_max2 = $sqlw->quote_smart($_POST['dmg_max2']);
  else $dmg_max2 = 0;
 if (isset($_POST['dmg_type2']) && $_POST['dmg_type2'] != '') $dmg_type2 = $sqlw->quote_smart($_POST['dmg_type2']);
  else $dmg_type2 = 0;
 if (isset($_POST['armor']) && $_POST['armor'] != '') $armor = $sqlw->quote_smart($_POST['armor']);
  else $armor = 0;
 if (isset($_POST['holy_res']) && $_POST['holy_res'] != '') $holy_res = $sqlw->quote_smart($_POST['holy_res']);
  else $holy_res = 0;
 if (isset($_POST['fire_res']) && $_POST['fire_res'] != '') $fire_res = $sqlw->quote_smart($_POST['fire_res']);
  else $fire_res = 0;
 if (isset($_POST['nature_res']) && $_POST['nature_res'] != '') $nature_res = $sqlw->quote_smart($_POST['nature_res']);
  else $nature_res = 0;
 if (isset($_POST['frost_res']) && $_POST['frost_res'] != '') $frost_res = $sqlw->quote_smart($_POST['frost_res']);
  else $frost_res = 0;
 if (isset($_POST['shadow_res']) && $_POST['shadow_res'] != '') $shadow_res = $sqlw->quote_smart($_POST['shadow_res']);
  else $shadow_res = 0;
 if (isset($_POST['arcane_res']) && $_POST['arcane_res'] != '') $arcane_res = $sqlw->quote_smart($_POST['arcane_res']);
  else $arcane_res = 0;
 if (isset($_POST['delay']) && $_POST['delay'] != '') $delay = $sqlw->quote_smart($_POST['delay']);
  else $delay = 0;
 if (isset($_POST['ammo_type']) && $_POST['ammo_type'] != '') $ammo_type = $sqlw->quote_smart($_POST['ammo_type']);
  else $ammo_type = 0;
 if (isset($_POST['RangedModRange']) && $_POST['RangedModRange'] != '') $RangedModRange = $sqlw->quote_smart($_POST['RangedModRange']);
  else $RangedModRange = 0;
 if (isset($_POST['spellid_1']) && $_POST['spellid_1'] != '') $spellid_1 = $sqlw->quote_smart($_POST['spellid_1']);
  else $spellid_1 = 0;
 if (isset($_POST['spelltrigger_1']) && $_POST['spelltrigger_1'] != '') $spelltrigger_1 = $sqlw->quote_smart($_POST['spelltrigger_1']);
  else $spelltrigger_1 = 0;
 if (isset($_POST['spellcharges_1']) && $_POST['spellcharges_1'] != '') $spellcharges_1 = $sqlw->quote_smart($_POST['spellcharges_1']);
  else $spellcharges_1 = 0;
 if (isset($_POST['spellcooldown_1']) && $_POST['spellcooldown_1'] != '') $spellcooldown_1 = $sqlw->quote_smart($_POST['spellcooldown_1']);
  else $spellcooldown_1 = -1;
 if (isset($_POST['spellcategory_1']) && $_POST['spellcategory_1'] != '') $spellcategory_1 = $sqlw->quote_smart($_POST['spellcategory_1']);
  else $spellcategory_1 = 0;
 if (isset($_POST['spellcategorycooldown_1']) && $_POST['spellcategorycooldown_1'] != '') $spellcategorycooldown_1 = $sqlw->quote_smart($_POST['spellcategorycooldown_1']);
  else $spellcategorycooldown_1 = -1;
 if (isset($_POST['spellppmRate_1']) && $_POST['spellppmRate_1'] != '') $spellppmRate_1 = $sqlw->quote_smart($_POST['spellppmRate_1']);
  else $spellppmRate_1 = 0;
 if (isset($_POST['spellid_2']) && $_POST['spellid_2'] != '') $spellid_2 = $sqlw->quote_smart($_POST['spellid_2']);
  else $spellid_2 = 0;
 if (isset($_POST['spelltrigger_2']) && $_POST['spelltrigger_2'] != '') $spelltrigger_2 = $sqlw->quote_smart($_POST['spelltrigger_2']);
  else $spelltrigger_2 = 0;
 if (isset($_POST['spellcharges_2']) && $_POST['spellcharges_2'] != '') $spellcharges_2 = $sqlw->quote_smart($_POST['spellcharges_2']);
  else $spellcharges_2 = 0;
 if (isset($_POST['spellcooldown_2']) && $_POST['spellcooldown_2'] != '') $spellcooldown_2 = $sqlw->quote_smart($_POST['spellcooldown_2']);
  else $spellcooldown_2 = -1;
 if (isset($_POST['spellcategory_2']) && $_POST['spellcategory_2'] != '') $spellcategory_2 = $sqlw->quote_smart($_POST['spellcategory_2']);
  else $spellcategory_2 = 0;
 if (isset($_POST['spellcategorycooldown_2']) && $_POST['spellcategorycooldown_2'] != '') $spellcategorycooldown_2 = $sqlw->quote_smart($_POST['spellcategorycooldown_2']);
  else $spellcategorycooldown_2 = -1;
 if (isset($_POST['spellppmRate_2']) && $_POST['spellppmRate_2'] != '') $spellppmRate_2 = $sqlw->quote_smart($_POST['spellppmRate_2']);
  else $spellppmRate_2 = 0;
 if (isset($_POST['spellid_3']) && $_POST['spellid_3'] != '') $spellid_3 = $sqlw->quote_smart($_POST['spellid_3']);
  else $spellid_3 = 0;
 if (isset($_POST['spelltrigger_3']) && $_POST['spelltrigger_3'] != '') $spelltrigger_3 = $sqlw->quote_smart($_POST['spelltrigger_3']);
  else $spelltrigger_3 = 0;
 if (isset($_POST['spellcharges_3']) && $_POST['spellcharges_3'] != '') $spellcharges_3 = $sqlw->quote_smart($_POST['spellcharges_3']);
  else $spellcharges_3 = 0;
 if (isset($_POST['spellcooldown_3']) && $_POST['spellcooldown_3'] != '') $spellcooldown_3 = $sqlw->quote_smart($_POST['spellcooldown_3']);
  else $spellcooldown_3 = -1;
 if (isset($_POST['spellcategory_3']) && $_POST['spellcategory_3'] != '') $spellcategory_3 = $sqlw->quote_smart($_POST['spellcategory_3']);
  else $description = 0;
 if (isset($_POST['spellcategorycooldown_3']) && $_POST['spellcategorycooldown_3'] != '') $spellcategorycooldown_3 = $sqlw->quote_smart($_POST['spellcategorycooldown_3']);
  else $spellcategorycooldown_3 = -1;
 if (isset($_POST['spellppmRate_3']) && $_POST['spellppmRate_3'] != '') $spellppmRate_3 = $sqlw->quote_smart($_POST['spellppmRate_3']);
  else $spellppmRate_3 = 0;
 if (isset($_POST['spellid_4']) && $_POST['spellid_4'] != '') $spellid_4 = $sqlw->quote_smart($_POST['spellid_4']);
  else $spellid_4 = 0;
 if (isset($_POST['spelltrigger_4']) && $_POST['spelltrigger_4'] != '') $spelltrigger_4 = $sqlw->quote_smart($_POST['spelltrigger_4']);
  else $spelltrigger_4 = 0;
 if (isset($_POST['spellcharges_4']) && $_POST['spellcharges_4'] != '') $spellcharges_4 = $sqlw->quote_smart($_POST['spellcharges_4']);
  else $spellcharges_4 = 0;
 if (isset($_POST['spellcooldown_4']) && $_POST['spellcooldown_4'] != '') $spellcooldown_4 = $sqlw->quote_smart($_POST['spellcooldown_4']);
  else $spellcooldown_4 = -1;
 if (isset($_POST['spellcategory_4']) && $_POST['spellcategory_4'] != '') $spellcategory_4 = $sqlw->quote_smart($_POST['spellcategory_4']);
  else $spellcategory_4 = 0;
 if (isset($_POST['spellcategorycooldown_4']) && $_POST['spellcategorycooldown_4'] != '') $spellcategorycooldown_4 = $sqlw->quote_smart($_POST['spellcategorycooldown_4']);
  else $spellcategorycooldown_4 = -1;
 if (isset($_POST['spellppmRate_4']) && $_POST['spellppmRate_4'] != '') $spellppmRate_4 = $sqlw->quote_smart($_POST['spellppmRate_4']);
  else $spellppmRate_4 = 0;
 if (isset($_POST['spellid_5']) && $_POST['spellid_5'] != '') $spellid_5 = $sqlw->quote_smart($_POST['spellid_5']);
  else $spellid_5 = 0;
 if (isset($_POST['spelltrigger_5']) && $_POST['spelltrigger_5'] != '') $spelltrigger_5 = $sqlw->quote_smart($_POST['spelltrigger_5']);
  else $spelltrigger_5 = 0;
 if (isset($_POST['spellcharges_5']) && $_POST['spellcharges_5'] != '') $spellcharges_5 = $sqlw->quote_smart($_POST['spellcharges_5']);
  else $spellcharges_5 = 0;
 if (isset($_POST['spellcooldown_5']) && $_POST['spellcooldown_5'] != '') $spellcooldown_5 = $sqlw->quote_smart($_POST['spellcooldown_5']);
  else $spellcooldown_5 = -1;
 if (isset($_POST['spellcategory_5']) && $_POST['spellcategory_5'] != '') $spellcategory_5 = $sqlw->quote_smart($_POST['spellcategory_5']);
  else $spellcategory_5 = 0;
 if (isset($_POST['spellcategorycooldown_5']) && $_POST['spellcategorycooldown_5'] != '') $spellcategorycooldown_5 = $sqlw->quote_smart($_POST['spellcategorycooldown_5']);
  else $spellcategorycooldown_5 = -1;
 if (isset($_POST['spellppmRate_5']) && $_POST['spellppmRate_5'] != '') $spellppmRate_5 = $sqlw->quote_smart($_POST['spellppmRate_5']);
  else $spellppmRate_5 = 0;
 if (isset($_POST['bonding']) && $_POST['bonding'] != '') $bonding = $sqlw->quote_smart($_POST['bonding']);
  else $bonding = 0;
 if (isset($_POST['description']) && $_POST['description'] != '') $description = $sqlw->quote_smart($_POST['description']);
  else $description = "";
 if (isset($_POST['PageText']) && $_POST['PageText'] != '') $PageText = $sqlw->quote_smart($_POST['PageText']);
  else $PageText = 0;
 if (isset($_POST['LanguageID']) && $_POST['LanguageID'] != '') $LanguageID = $sqlw->quote_smart($_POST['LanguageID']);
  else $LanguageID = 0;
 if (isset($_POST['PageMaterial']) && $_POST['PageMaterial'] != '') $PageMaterial = $sqlw->quote_smart($_POST['PageMaterial']);
  else $PageMaterial = 0;
 if (isset($_POST['startquest']) && $_POST['startquest'] != '') $startquest = $sqlw->quote_smart($_POST['startquest']);
  else $startquest = 0;
 if (isset($_POST['lockid']) && $_POST['lockid'] != '') $lockid = $sqlw->quote_smart($_POST['lockid']);
  else $lockid = 0;
 if (isset($_POST['Material']) && $_POST['Material'] != '') $Material = $sqlw->quote_smart($_POST['Material']);
  else $Material = 0;
 if (isset($_POST['sheath']) && $_POST['sheath'] != '') $sheath = $sqlw->quote_smart($_POST['sheath']);
  else $sheath = 0;
 if (isset($_POST['RandomProperty']) && $_POST['RandomProperty'] != '') $RandomProperty = $sqlw->quote_smart($_POST['RandomProperty']);
  else $RandomProperty = 0;
 if (isset($_POST['block ']) && $_POST['block '] != '') $block = $sqlw->quote_smart($_POST['block']);
  else $block  = 0;
 if (isset($_POST['itemset']) && $_POST['itemset'] != '') $itemset = $sqlw->quote_smart($_POST['itemset']);
  else $itemset = 0;
 if (isset($_POST['MaxDurability']) && $_POST['MaxDurability'] != '') $MaxDurability = $sqlw->quote_smart($_POST['MaxDurability']);
  else $MaxDurability = 0;
 if (isset($_POST['area']) && $_POST['area'] != '') $area = $sqlw->quote_smart($_POST['area']);
  else $area = 0;
 if (isset($_POST['BagFamily']) && $_POST['BagFamily'] != '') $BagFamily = $sqlw->quote_smart($_POST['BagFamily']);
  else $BagFamily = 0;
 if (isset($_POST['Map']) && $_POST['Map'] != '') $Map = $sqlw->quote_smart($_POST['Map']);
  else $Map = 0;
 if (isset($_POST['ScriptName']) && $_POST['ScriptName'] != '') $ScriptName = $sqlw->quote_smart($_POST['ScriptName']);
  else $ScriptName = 0;
 if (isset($_POST['DisenchantID']) && $_POST['DisenchantID'] != '') $DisenchantID = $sqlw->quote_smart($_POST['DisenchantID']);
  else $DisenchantID = 0;
 if (isset($_POST['RequiredDisenchantSkill']) && $_POST['RequiredDisenchantSkill'] != '') $RequiredDisenchantSkill = $sqlw->quote_smart($_POST['RequiredDisenchantSkill']);
  else $RequiredDisenchantSkill = -1;
 if (isset($_POST['unk0']) && $_POST['unk0'] != '') $unk0 = $sqlw->quote_smart($_POST['unk0']);
  else $unk0 = -1;
 if (isset($_POST['RandomSuffix']) && $_POST['RandomSuffix'] != '') $RandomSuffix = $sqlw->quote_smart($_POST['RandomSuffix']);
  else $RandomSuffix = 0;
 if (isset($_POST['TotemCategory']) && $_POST['TotemCategory'] != '') $TotemCategory = $sqlw->quote_smart($_POST['TotemCategory']);
  else $TotemCategory = 0;
 if (isset($_POST['socketColor_1']) && $_POST['socketColor_1'] != '') $socketColor_1 = $sqlw->quote_smart($_POST['socketColor_1']);
  else $socketColor_1 = 0;
 if (isset($_POST['socketContent_1']) && $_POST['socketContent_1'] != '') $socketContent_1 = $sqlw->quote_smart($_POST['socketContent_1']);
  else $socketContent_1 = 0;
 if (isset($_POST['socketColor_2']) && $_POST['socketColor_2'] != '') $socketColor_2 = $sqlw->quote_smart($_POST['socketColor_2']);
  else $socketColor_2 = 0;
 if (isset($_POST['socketContent_2']) && $_POST['socketContent_2'] != '') $socketContent_2 = $sqlw->quote_smart($_POST['socketContent_2']);
  else $socketContent_2 = 0;
 if (isset($_POST['socketColor_3']) && $_POST['socketColor_3'] != '') $socketColor_3 = $sqlw->quote_smart($_POST['socketColor_3']);
  else $socketColor_3 = 0;
 if (isset($_POST['socketContent_3']) && $_POST['socketContent_3'] != '') $socketContent_3 = $sqlw->quote_smart($_POST['socketContent_3']);
  else $socketContent_3 = 0;
 if (isset($_POST['socketBonus']) && $_POST['socketBonus'] != '') $socketBonus = $sqlw->quote_smart($_POST['socketBonus']);
  else $socketBonus = 0;
 if (isset($_POST['GemProperties']) && $_POST['GemProperties'] != '') $GemProperties = $sqlw->quote_smart($_POST['GemProperties']);
  else $GemProperties = 0;
 if (isset($_POST['ArmorDamageModifier']) && $_POST['ArmorDamageModifier'] != '') $ArmorDamageModifier = $sqlw->quote_smart($_POST['ArmorDamageModifier']);
  else $ArmorDamageModifier = 0;

  if (isset($_POST['de_ChanceOrQuestChance']) && $_POST['de_ChanceOrQuestChance'] != '') $de_ChanceOrQuestChance = $sqlw->quote_smart($_POST['de_ChanceOrQuestChance']);
    else $de_ChanceOrQuestChance = 0;
  if (isset($_POST['de_groupid']) && $_POST['de_groupid'] != '') $de_groupid = $sqlw->quote_smart($_POST['de_groupid']);
    else $de_groupid = 0;
  if (isset($_POST['de_mincountOrRef']) && $_POST['de_mincountOrRef'] != '') $de_mincountOrRef = $sqlw->quote_smart($_POST['de_mincountOrRef']);
    else $de_mincountOrRef = 0;
  if (isset($_POST['de_maxcount']) && $_POST['de_maxcount'] != '') $de_maxcount = $sqlw->quote_smart($_POST['de_maxcount']);
    else $de_maxcount = 0;
  if (isset($_POST['de_lootcondition']) && $_POST['de_lootcondition'] != '') $de_lootcondition = $sqlw->quote_smart($_POST['de_lootcondition']);
    else $de_lootcondition = 0;
  if (isset($_POST['de_condition_value1']) && $_POST['de_condition_value1'] != '') $de_condition_value1 = $sqlw->quote_smart($_POST['de_condition_value1']);
    else $de_condition_value1 = 0;
  if (isset($_POST['de_condition_value2']) && $_POST['de_condition_value2'] != '') $de_condition_value2 = $sqlw->quote_smart($_POST['de_condition_value2']);
    else $de_condition_value2 = 0;
  if (isset($_POST['de_item']) && $_POST['de_item'] != '') $de_item = $sqlw->quote_smart($_POST['de_item']);
    else $de_item = 0;
  if (isset($_POST['del_de_items']) && $_POST['del_de_items'] != '') $del_de_items = $sqlw->quote_smart($_POST['del_de_items']);
  ...
  $sql_query = "INSERT INTO items (entry, class, subclass, name1, displayid, Quality, Flags, BuyPrice, SellPrice, InventoryType, AllowableClass, AllowableRace, ItemLevel,
  RequiredLevel, RequiredSkill, RequiredSkillRank, requiredspell, RequiredFaction, RequiredFactionStanding, maxcount, ContainerSlots, stat_type1,
  ...
  spellid_2, spelltrigger_2, spellcharges_2, spellcooldown_2, spellcategory_2, spellcategorycooldown_2, spellid_3, spelltrigger_3, spellcharges_3, spellcooldown_3, spellcategory_3, spellcategorycooldown_3,
  ...
  bonding, description, Page_id, page_Language, Page_Material, quest_id, lock_id, lock_Material, sheathid, RandomProp, block, itemset, MaxDurability, zonenameid, BagFamily, Mapid, ReqDisenchantSkill,
  ArmorDamageModifier,RandomSuffix,TotemCategory, socket_Color_1, socket_Color_2, socket_Color_3, socket_Bonus, GemProperties)
  VALUES ('$entry', '$class', '$subclass', '$name','$displayid', '$Quality', '$Flags', '$BuyPrice', '$SellPrice', '$InventoryType', '$AllowableClass', '$AllowableRace', '$ItemLevel', '$RequiredLevel',
  '$RequiredSkill', '$RequiredSkillRank', '$requiredspell', '$RequiredReputationFaction', '$RequiredReputationRank', '$maxcount', '$ContainerSlots', '$stat_type1',
  ...
  '$stat_type9', '$stat_value9', '$stat_type10', '$stat_value10', '$dmg_min1', '$dmg_max1', '$dmg_type1', '$dmg_min2', '$dmg_max2', '$dmg_type2', '$armor', '$holy_res', '$fire_res', '$nature_res', '$frost_res', '$shadow_res', '$arcane_res', '$delay', '$ammo_type', '$RangedModRange', '$spellid_1', '$spelltrigger_1', '$spellcharges_1', '$spellcooldown_1',
  '$spellcategory_1', '$spellcategorycooldown_1', '$spellid_2', '$spelltrigger_2', '$spellcharges_2', '$spellcooldown_2', '$spellcategory_2', '$spellcategorycooldown_2', '$spellid_3', '$spelltrigger_3', '$spellcharges_3', 
  '$spellcooldown_3', '$spellcategory_3', '$spellcategorycooldown_3', '$spellid_4', '$spelltrigger_4', '$spellcharges_4', '$spellcooldown_4', '$spellcategory_4', '$spellcategorycooldown_4', '$spellid_5', '$spelltrigger_5',
  '$spellcharges_5', '$spellcooldown_5', '$spellcategory_5', '$spellcategorycooldown_5', '$bonding', '$description', '$PageText', '$LanguageID', '$PageMaterial', '$startquest', '$lockid', '$Material', '$sheath', '$RandomProperty', '$block',
  '$itemset', '$MaxDurability', '$area', '$BagFamily', '$Map', '$RequiredDisenchantSkill','$ArmorDamageModifier','$RandomSuffix', '$TotemCategory', '$socketColor_1', '$socketColor_2',
  '$socketColor_3', '$socketBonus', '$GemProperties')";

 } elseif ($_POST['type'] == "edit"){

  $sql_query = "UPDATE items SET  ";

  //$result = $sql->query("SELECT `items`.`entry`,`class`,`subclass`,`unk0`,IFNULL(".($deplang<>0?"name_loc$deplang":"NULL").",`name1`) as name,`displayid`,`Quality`,`Flags`,`BuyCount`,`BuyPrice`,`SellPrice`,`InventoryType`,`AllowableClass`,`AllowableRace`,`ItemLevel`,`RequiredLevel`,`RequiredSkill`,`RequiredSkillRank`,`requiredspell`,`requiredhonorrank`,`RequiredCityRank`,`RequiredReputationFaction`,`RequiredReputationRank`,`maxcount`,`stackable`,`ContainerSlots`,`stat_type1`,`stat_value1`,`stat_type2`,`stat_value2`,`stat_type3`,`stat_value3`,`stat_type4`,`stat_value4`,`stat_type5`,`stat_value5`,`stat_type6`,`stat_value6`,`stat_type7`,`stat_value7`,`stat_type8`,`stat_value8`,`stat_type9`,`stat_value9`,`stat_type10`,`stat_value10`,`dmg_min1`,`dmg_max1`,`dmg_type1`,`dmg_min2`,`dmg_max2`,`dmg_type2`,`armor`,`holy_res`,`fire_res`,`nature_res`,`frost_res`,`shadow_res`,`arcane_res`,`delay`,`ammo_type`,`RangedModRange`,`spellid_1`,`spelltrigger_1`,`spellcharges_1`,`spellppmRate_1`,`spellcooldown_1`,`spellcategory_1`,`spellcategorycooldown_1`,`spellid_2`,`spelltrigger_2`,`spellcharges_2`,`spellppmRate_2`,`spellcooldown_2`,`spellcategory_2`,`spellcategorycooldown_2`,`spellid_3`,`spelltrigger_3`,`spellcharges_3`,`spellppmRate_3`,`spellcooldown_3`,`spellcategory_3`,`spellcategorycooldown_3`,`spellid_4`,`spelltrigger_4`,`spellcharges_4`,`spellppmRate_4`,`spellcooldown_4`,`spellcategory_4`,`spellcategorycooldown_4`,`spellid_5`,`spelltrigger_5`,`spellcharges_5`,`spellppmRate_5`,`spellcooldown_5`,`spellcategory_5`,`spellcategorycooldown_5`,`bonding`,`description`,`PageText`,`LanguageID`,`PageMaterial`,`startquest`,`lockid`,`Material`,`sheath`,`RandomProperty`,`RandomSuffix`,`block`,`itemset`,`MaxDurability`,`area`,`Map`,`BagFamily`,`TotemCategory`,`socketColor_1`,`socketContent_1`,`socketColor_2`,`socketContent_2`,`socketColor_3`,`socketContent_3`,`socketBonus`,`GemProperties`,`RequiredDisenchantSkill`,`ArmorDamageModifier`,`ScriptName`,`DisenchantID`,`FoodType`,`minMoneyLoot`,`maxMoneyLoot` FROM items LEFT JOIN locales_item ON items.entry = locales_item.entry WHERE items.entry = '$entry'");
  $result = $sqlw->query("SELECT `items`.`entry`,`class`,`subclass`,`name1`,`displayid`,`Quality`,`Flags`,`BuyPrice`,`SellPrice`,`InventoryType`,`AllowableClass`,`AllowableRace`,`ItemLevel`,`RequiredLevel`,`RequiredSkill`,`RequiredSkillRank`,`requiredspell`,`RequiredFaction`,`RequiredFactionStanding`,`maxcount`,`ContainerSlots`,`stat_type1`,`stat_value1`,`stat_type2`,`stat_value2`,`stat_type3`,`stat_value3`,`stat_type4`,`stat_value4`,`stat_type5`,`stat_value5`,`stat_type6`,`stat_value6`,`stat_type7`,`stat_value7`,`stat_type8`,`stat_value8`,`stat_type9`,`stat_value9`,`stat_type10`,`stat_value10`,`dmg_min1`,`dmg_max1`,`dmg_type1`,`dmg_min2`,`dmg_max2`,`dmg_type2`,`armor`,`holy_res`,`fire_res`,`nature_res`,`frost_res`,`shadow_res`,`arcane_res`,`delay`,`ammo_type`,`spellid_1`,`spelltrigger_1`,`spellcharges_1`,`spellcooldown_1`,`spellcategory_1`,`spellcategorycooldown_1`,`spellid_2`,`spelltrigger_2`,`spellcharges_2`,`spellcooldown_2`,`spellcategory_2`,`spellcategorycooldown_2`,`spellid_3`,`spelltrigger_3`,`spellcharges_3`,`spellcooldown_3`,`spellcategory_3`,`spellcategorycooldown_3`,`spellid_4`,`spelltrigger_4`,`spellcharges_4`,`spellcooldown_4`,`spellcategory_4`,`spellcategorycooldown_4`,`spellid_5`,`spelltrigger_5`,`spellcharges_5`,`spellcooldown_5`,`spellcategory_5`,`spellcategorycooldown_5`,`bonding`,`description`,`Page_id`,`page_Language`,`Page_Material`,`quest_id`,`lock_id`,`lock_Material`,`sheathid`,`RandomProp`,`RandomSuffix`,`block`,`itemset`,`MaxDurability`,`zonenameid`,`Mapid`,`BagFamily`,`TotemCategory`,`socket_Color_1`,`socket_Color_2`,`socket_Color_3`,`socket_Bonus`,`GemProperties`,`ReqDisenchantSkill`,`ArmorDamageModifier` FROM items WHERE items.entry = '$entry'");
  if ($item_templ = $sqlw->fetch_assoc($result)){
    ...
    if ($item_templ['RequiredReputationFaction'] != $RequiredReputationFaction) $sql_query .= "RequiredFaction='$RequiredReputationFaction',";
    if ($item_templ['RequiredReputationRank'] != $RequiredReputationRank) $sql_query .= "RequiredFactionStanding='$RequiredReputationRank',";
    ...
    if ($item_templ['RangedModRange'] != $RangedModRange) $sql_query .= "'Range'='$RangedModRange',";
    ...
    if ($item_templ['PageText'] != $PageText) $sql_query .= "Page_id='$PageText',";
    if ($item_templ['LanguageID'] != $LanguageID) $sql_query .= "Page_Language='$LanguageID',";
    if ($item_templ['PageMaterial'] != $PageMaterial) $sql_query .= "Page_Material='$PageMaterial',";
    if ($item_templ['startquest'] != $startquest) $sql_query .= "questid='$startquest',";
    if ($item_templ['lockid'] != $lockid) $sql_query .= "lock_id='$lockid',";
    if ($item_templ['Material'] != $Material) $sql_query .= "lock_Material='$Material',";
    if ($item_templ['sheath'] != $sheath) $sql_query .= "sheathid='$sheath',";
    if ($item_templ['RandomProperty'] != $RandomProperty) $sql_query .= "RandomProp='$RandomProperty',";
    ...
    if ($item_templ['area'] != $area) $sql_query .= "zonenameid='$area',";
    if ($item_templ['BagFamily'] != $BagFamily) $sql_query .= "BagFamily='$BagFamily',";
    if ($item_templ['Map'] != $Map) $sql_query .= "Mapid='$Map',";
    if ($item_templ['RequiredDisenchantSkill'] != $ReqDisenchantSkill) $sql_query .= "RequiredDisenchantSkill='$RequiredDisenchantSkill',";
    ...
    if ($item_templ['socketColor_1'] != $socketColor_1) $sql_query .= "socket_Color_1='$socketColor_1',";
    if ($item_templ['socketColor_2'] != $socketColor_2) $sql_query .= "socket_Color_2='$socketColor_2',";
    if ($item_templ['socketColor_3'] != $socketColor_3) $sql_query .= "socket_Color_3='$socketColor_3',";
    if ($item_templ['socketBonus'] != $socketBonus) $sql_query .= "socket_Bonus='$socketBonus',";
    if ($item_templ['GemProperties'] != $GemProperties) $sql_query .= "GemProperties='$GemProperties',";

  $sqlw->free_result($result);
  unset($item_templ);

    if (($sql_query == "UPDATE  SET  ")&&(!$de_item)&&(!$del_de_items)){
    //$sql->close();
    redirect("item.php?action=edit&entry=$entry&error=6");
    } else {
        if ($sql_query != "UPDATE  SET  "){
...
function delete()
{
  ...
  $output .= "
        <center>
          ...
          <br />
          <font class=\"bold\">
            ".lang('item_edit', 'item_id').": <a href=\"item.php?action=edit&amp;entry=$entry\" target=\"_blank\">$entry</a>
          ...
          <table class=\"hidden\">
            <tr>
              <td>";
                makebutton(lang('global', 'yes'), "item.php?action=do_delete&amp;entry=$entry\" type=\"warn",130);
                makebutton(lang('global', 'no'), "item.php",130);
  $output .= "
              </td>
            </tr>
          </table>
...
function do_delete()
{
  ...
  $result = $sqlw->query("DELETE FROM items WHERE entry = '$entry'");
...
switch ($err)
{
  ...
  case 2:
    $output .= "
          <h1><font class=\"error\">".lang('item_edit', 'search_results')."</font></h1>";
    break;
  case 3:
    $output .= "
          <h1><font class=\"error\">".lang('item_edit', 'add_new_item')."</font></h1>";
    break;
  case 4:
    $output .= "
          <h1><font class=\"error\">".lang('item_edit', 'edit_item')."</font></h1>";
    break;
  case 5:
    $output .= "
          <h1><font class=\"error\">".lang('item_edit', 'err_adding_item')."</font></h1>";
    break;
  case 6:
    $output .= "
          <h1><font class=\"error\">".lang('item_edit', 'err_no_field_updated')."</font></h1>";
    break;
  default: //no error
    $output .= "
          <h1>".lang('item_edit', 'search_items')."</h1>";
}
$output .= "
        </div>";
