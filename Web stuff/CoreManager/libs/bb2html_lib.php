...
function bb2html($text)
{
  ...
  $htmlcode = array("&lt;", "&gt;",
                ...
                '<a href="', "</a>",
                '<a href="mailto:', "</a>",
                '<table style="width: 100% background-color: lightgray;"><tr><td style="background-color: white;"><code>', "</code></td></tr></table>",
                '<table style="width: 100%; background-color: CornflowerBlue;"><tr><td style="background-color: white;">', "</td></tr></table>",
