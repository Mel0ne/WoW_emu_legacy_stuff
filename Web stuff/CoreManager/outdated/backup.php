...
//
// this_is_junk: This is going to need rewriting to work. :(
//
...
{
  global $lang_backup, $lang_global, $output, $backup_dir, $characters_db;
...
function dobackup()
{
  global $lang_backup,$backup_dir, $tables_backup_realmd, $tables_backup_characters, $$tables_backup_characters_trinity, $output,
